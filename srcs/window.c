...
/*   Updated: 2022/03/21 18:38:04 by mloubet          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	draw_color(0, 0, game->width , game->height / 2 , create_trgb( 200, 100, 100, 100), game);
	draw_color(0 , game->height / 2 , game->width, game->height,  create_trgb( 200, 200, 200, 50), game);
...
void	window_display(t_game *game)
{
	...
	mlx_get_screen_size(game->mlx.ptr, &(game->width), &(game->height));
	game->mlx.win = mlx_new_window(game->mlx.ptr,
			game->width, game->height, "player");
